  ...
  return <div className="bg-black h-screen flex">
    <div className="my-auto">
      <div className="h-12 flex text-white">
        ...
        <p>메뉴2</p>
        <p>메뉴3</p>
        <FontAwesomeIcon className="size-7" icon="fa-solid fa-camera-rotate" />
      </div>
      
      <div className="absolute w-3/5 h-20 bg-slate-950/20 blur-2xl left-1/2 transform -translate-x-1/2 translate-y-2/3"></div>
      ...
      <div>
        ...
        <img className="" src="http://placehold.it/1080x1800" />
      </div>
